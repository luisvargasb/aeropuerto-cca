 ...
 * NuevoAeropurto.java
 *
 * Created on Sep 15, 2011, 12:11:22 PM
 */
package proyecto1;
 ...
 * @author odra
 */
public class NuevoAeropurto extends javax.swing.JFrame {

    /** Creates new form NuevoAeropurto */
    public NuevoAeropurto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(proyecto1.Proyecto1App.class).getContext().getResourceMap(NuevoAeropurto.class);
    ...
    private void grabarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grabarMouseClicked
        ...
        // TODO add your handling code here:}//GEN-LAST:event_grabarMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NuevoAeropurto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new NuevoAeropurto().setVisible(true);
            }
        });
    }
